...
public interface UsersRepository extends JpaRepository<Users, Integer>,JpaSpecificationExecutor<Users> {
	 ...
	 */
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,u.userNumber,u.userPassword,u.userBirthday,u.userSex,u.userPhoto,u.userEmail,u.userPhone,u.userStatus,u.jdictionId,u.userSite) from Users u where u.userId=:userId and u.userPassword=:userPassword and u.jdictionId=:jdictionId and u.userStatus=0")
